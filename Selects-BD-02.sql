...
---------------------------------------------------------------------------------------
-- QUAL A EMPRESA BRASILEIRA COM A MAIOR QUANTIDADE DE VOOS, QUE SÓ 
-- ATUOU COM VOOS COM SERVIÇO DE TIPO DE LINHA MISTA (NÃO TEVE VOOS COM 
-- COM SERVIÇO DE TIPO DE LINHA CARGUEIRA)

SELECT
	   ID_EMPRESA AS [EMPRESA],
	   COUNT(ID_EMPRESA) AS [QTD VÔOS]
FROM TB_VOO
